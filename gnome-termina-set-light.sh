...
gconftool-2 -s -t string /apps/gnome-terminal/profiles/Default/background_color "#f3f3f4f4f6f6"

gconftool-2 -s -t string /apps/gnome-terminal/profiles/Default/foreground_color "#18181b1b2121"
